...
def screenshot():
    ...
    img_path = os.path.expanduser(r"C:\Users\lina2\OneDrive\Desktop\Jarvis-Desktop-Voice-Assistant-main\Jarvis-Desktop-Voice-Assistant-main\Images\li.png")
    img.save(img_path)
    
def play_music():
    song_dir = os.path.expanduser(r"C:\Users\lina2\OneDrive\Desktop\Jarvis-Desktop-Voice-Assistant-main\Jarvis-Desktop-Voice-Assistant-main\Music")
